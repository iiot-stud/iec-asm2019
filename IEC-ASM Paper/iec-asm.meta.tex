...
\newcommand{\metaInstFirst}{TU Berlin, Berlin, Germany,\\ Department for Open Communication Systems}

\newcommand{\metaAuthorXXX}{Farah Nasir}
\newcommand{\metaMailXXX}{first.last@example.org}
\newcommand{\metaInstXXX}{TU Berlin, Berlin, Germany,\\Department for Open Communication Systems}
% ------------------------------------------------------------------------------
